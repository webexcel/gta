                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><!-- Place Holder for Add Student-->  <form>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="bName" type="text" ng-model="aBatch.bname" placeholder="Enter Batch name" />
										 ...
										 <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <select class="form-control form-select-sm" id="program" ng-model="aBatch.program" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="hours" ng-model="aBatch.hours">
                                                        <option value="">Select Any One</option>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                <select class="form-control form-select-sm" id="centre" ng-model="aBatch.centre" required>
                                                        <option value="">Select Any One</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="faculty" ng-model="aBatch.faculty">
                                                        <option value="">Select Any One</option>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="date" type="date" ng-model="aBatch.sdate"/>  
                                                    <label for="date">Start Date</label>    
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="date" type="date" ng-model="aBatch.edate"/>  
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="timing" type="text" ng-model="aBatch.timing" placeholder="Enter your first name" />
                                                    <label for="inputFirstName">Enter Timings</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="type" ng-model="aBatch.type" >
                                        ...
                                        <div class="mt-1 mb-0">
                                            <div class="d-grid"><a class="btn btn-primary btn-block"  ng-click="saveBatch()">Save Batch</a></div>
                                        </div>
