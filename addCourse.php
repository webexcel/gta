                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="courseName" type="text" placeholder="Enter your first name" ng-model="aCourse.courseName" />
                                                    <label for="courseName">Course Name</label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-floating">
                                                <select class="form-control form-select-sm" id="program" ng-model="aCourse.program" required>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="timing" ng-model="aCourse.timing" >
                                                        <option value="">Select Any One</option>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="feeamount" type="text" ng-model="aCourse.feeamount"  />
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                <select class="form-control form-select-sm" id="centre" ng-model="aCourse.centre" required>
                                                        <option value="">Select Any One</option>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <div class="mt-2 mb-0">
                                                        <div class="d-grid"><a class="btn btn-primary btn-block" href="#" ng-click="saveCourse()">Save Course</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
