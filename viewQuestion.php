				...
				<div class="modal-body">
					<div class="card mb-4">
									...
									<div class="card-body"><!-- Place Holder for Add Student-->  <form>
                                        ...
                                        <div class="mt-1 mb-0">
											<div class="d-grid"><a class="btn btn-primary btn-block"  ng-click="UpdateQuestion(EditQus)" data-toggle="modal" data-target="#editStudentModal">Upload Question</a></div>
                                        </div>
                                    </div>
